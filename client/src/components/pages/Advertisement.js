...
import AdvertisementAddModal from "../partials/AdvertisementAddModal";
import AdvertisementUpdateModal from "../partials/AdvertisementUpdateModal";
...
class Advertisement extends Component {
    ...
    constructor(props) {
            ...
            
            {
                ...
                cell: record => {
                    ...
                    return (
                        ...
                        <button
                                data-toggle="modal"
                                data-target="#update-template-modal1"
        ...
        this.config = {
            ...
            no_data_text: 'No Advertisement found!',
    ...
    getData() {
        axios
            .post(url+"api/advertisement-list")
            .then(res => {
                console.log(res,'userresadasdfaserwree 4234')
    ...
    deleteRecord(record) {
        axios
            .post(url+"api/advertisement-delete", {id: record.id})
            .then(res => {
                if (res.status === 200) {
...
this.setState({modalshow1:false});
 ...
 changestatus(record) {
        axios
            .post(url+"api/advertisement-changestatus", {id: record.id})
            .then(res => {
    ...
    changemoderator(record) {
        axios
            .post(url+"api/advertisement-changemoderator", {_id: record._id})
            .then(res => {  
                console.log(res,'reschange');
                if (res.status === 200) {
                   toast(res.data.message, {
            ...
            <div>
                ...
                <div className="d-flex" id="wrapper">
                    ...
                    <AdvertisementAddModal/>
                     <AdvertisementUpdateModal record={this.state.currentRecord}/>
                    {/* <UserUpdateModal record={this.state.currentRecord}/>*/}
                    <div id="page-content-wrapper">
                        <div className="container-fluid">
                            <button className="btn btn-outline-primary float-right mt-3 mr-2" data-toggle="modal" data-target="#add-advertisement-modal"><FontAwesomeIcon icon={faPlus}/> add</button>
                            <h3 className="mt-2 text-secondary">Advertisement Management</h3>
                            <ReactDatatable
