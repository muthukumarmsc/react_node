...
import SubscriptionAddModal from "../partials/SubscriptionAddModal";
import SubscriptionUpdateModal from "../partials/SubscriptionUpdateModal";
...
class Subscription extends Component {
    ...
    getData() {
        axios
            .post(url+"api/subscription-data")
            .then(res => {
    ...
    deleteRecord(record) {
        axios
            .post(url+"api/subscription-delete", {id: record.id})
            .then(res => {
                if (res.status === 200) {
...
this.setState({modalshow1:false});
 ...
 changestatus(record) {
        axios
            .post(url+"api/subscription-changestatus", {id: record.id})
            .then(res => {
            ...
            <div>
                ...
                <div className="d-flex" id="wrapper">
                    ...
                    <SubscriptionAddModal/>
                     <SubscriptionUpdateModal record={this.state.currentRecord}/>
                    <div id="page-content-wrapper">
                        <div className="container-fluid">
                            ...
                            <h3 className="mt-2 text-secondary">Subscription Management</h3>
                            <br/>
                           <CsvDownloader  filename="Subscription" columns={this.state.columns} datas={this.state.records}
                           text="Csv" />
